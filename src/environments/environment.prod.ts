...
declare const ENV_ML_ARTIST_DISCOVERY_SEARCH_URL;
declare const ENV_ML_ARTIST_DISCOVERY_ARTIST_URL;
declare const ENV_ML_ARTIST_FBPAGE_SEARCH_URL;
declare const ENV_ML_ARTIST_FBPAGE_GOOGLE_SEARCH_URL;
